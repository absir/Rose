...
{
public:
	explicit tbakreader(const std::string& src_name, bool use_backup, const boost::function<bool (tfile& file, int64_t dsize, bool bak)>& did_read);
...
protected:
	...
	bool use_backup_;
	const boost::function<bool (tfile& file, int64_t dsize, bool bak)> did_read_;
};

class tsha1reader: public tbakreader
{
public:
	explicit tsha1reader(const std::string& src_name, bool use_backup, const boost::function<bool (tfile& file, int64_t dsize, bool bak)>& did_read)
...
{
public:
	explicit tbakwriter(const std::string& src_name, bool use_backup, const boost::function<bool (tfile& file)>& did_write);
...
protected:
	...
	std::string bak_name_;
	bool use_backup_;
	const boost::function<bool (tfile& file)> did_write_;
};

class tsha1writer: tbakwriter
{
public:
	explicit tsha1writer(const std::string& src_name, bool use_backup, const boost::function<bool (tfile& file)>& did_write)
