...
public:
	struct tslot {
	public:
		tslot(const boost::function<bool (tprogress_&)>& did_first_drawn, const std::string& cancel_img)
	...
	public:
		const boost::function<bool (tprogress_&)> did_first_drawn;
...
{
public:
	tprogress_default_slot(const boost::function<bool (tprogress_&)>& did_first_drawn, const std::string& cancel_img = "", int align = nposm);
