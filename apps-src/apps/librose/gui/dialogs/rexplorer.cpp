...
void trexplorer::pre_show()
{
	...
	window_->set_label("misc/black-background.png");
	// window_->set_label("misc/decorate-background.png");
	// window_->set_label("misc/red-background.png");
	...
	navigate_->set_did_item_click(boost::bind(&trexplorer::click_navigate, this, boost::ref(*window_), _2));

	tlistbox& list = find_widget<tlistbox>(explorer_grid_, "default", false);
	if (!click_open_dir_) {
		list.set_did_row_double_click(boost::bind(&trexplorer::did_item_double_click, this, _1, _2));
	}
	list.set_did_row_changed(boost::bind(&trexplorer::did_item_selected, this, _1, _2));
...
void trexplorer::init_entry(twindow& window)
{
	...
	root.set_did_row_changed(boost::bind(&trexplorer::did_root_changed, this, _1, _2));
...
void trexplorer::handle_edit_item(int type)
{
	...
	int cancel_seconds = 0; // always show
	{
		...
		param.did_text_changed = boost::bind(&trexplorer::verify_edit_item, this, _1, def, type);
		{
...
void trexplorer::start_drag2(const tpoint& coordinate, int files, bool has_folder)
{
	...
	window_->start_drag(coordinate, boost::bind(&trexplorer::did_drag_mouse_motion, this, _1, _2),
		boost::bind(&trexplorer::did_drag_mouse_leave, this, _1, _2, _3));
