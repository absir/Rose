...
namespace net {
extern bool fetch_url_data(const std::string& _url, const std::string& path, int timeout);
}
...
*/
	...
	{
		// bool ret = net::fetch_url_data("https://13.229.188.59:443", game_config::preferences_dir + "/1.html", 60000);
