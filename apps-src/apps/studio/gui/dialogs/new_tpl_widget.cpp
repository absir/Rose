...
void tnew_tpl_widget::pre_show()
{
	...
	options->set_did_item_changed(boost::bind(&tnew_tpl_widget::did_option_changed, this, _2));
	...
	text_box->set_did_text_changed(boost::bind(&tnew_tpl_widget::did_id_changed, this, boost::ref(*window_), _1));
	...
	report->set_did_item_changed(boost::bind(&tnew_tpl_widget::did_app_changed, this, _2));
