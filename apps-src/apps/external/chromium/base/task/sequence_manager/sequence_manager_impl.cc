...
void SequenceManagerImpl::DeletePendingTasks() {
  // librose require calling DeletePendingTasks when outside RunLoop.
  // so remark below DCHECK. After doing so, it is not certain whether any fatal errors will be caused.
/*
